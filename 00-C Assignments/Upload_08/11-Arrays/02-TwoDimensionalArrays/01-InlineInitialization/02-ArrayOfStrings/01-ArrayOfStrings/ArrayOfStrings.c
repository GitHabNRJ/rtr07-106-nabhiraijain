...
int main(int args[], int* argv[], int* envp)
{
    ...
    printf("%s", nrjstrArray[0]);
    printf("%s", nrjstrArray[1]);
    printf("%s", nrjstrArray[2]);
    printf("%s", nrjstrArray[3]);
    printf("%s", nrjstrArray[4]);
    printf("%s", nrjstrArray[5]);
    printf("%s", nrjstrArray[6]);
    printf("%s", nrjstrArray[7]);
    printf("%s", nrjstrArray[8]);
    printf("%s", nrjstrArray[9]);
    printf("\n\n");
 ...
 ****/
    ...
    nrjstrArray_num_columns = sizeof(nrjstrArray[0]) / (nrjchar_size);
    ...
    printf("Size of  (2D) Character Array (String Array) is %d\n\n", nrjchar_size);
   
    printf("No of rows(Strings) in (2D) Character Array (String Array) is %d\n\n", nrjstrArray_num_rows);

    printf("No of columns in (2D)  Character Array (String Array )is %d\n\n", nrjstrArray_num_columns);

    printf("Maximum Number of elements (Characters) in Two Dimentional(2D) String Array is %d\n\n", nrjstrArray_num_elements);

    for (i = 0; i < nrjstrArray_num_rows; i++)
    {

        strActual_num_chars=  strActual_num_chars + strlen(nrjstrArray[i]);
