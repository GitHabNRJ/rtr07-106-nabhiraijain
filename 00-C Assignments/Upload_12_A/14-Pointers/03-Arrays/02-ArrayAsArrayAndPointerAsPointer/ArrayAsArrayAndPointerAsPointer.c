...
int main(int args[], int* argv[], int* envp[])
{
	...
	//code
	printf("\n\n");
	//*************Using Array Name as an Array i:e Value of ith element of inrjArry:inrjArray[i] and address of xth element of inrjArray:inrjArray[i]
	printf("Using Array Name as an Array i:e Value of ith element of inrjArry:inrjArray[i] and address of xth element of inrjArray:inrjArray[i]:\n\n");
